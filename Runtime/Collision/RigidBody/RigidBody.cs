...
namespace Scellecs.Morpeh.Physics
{
    ...
    public struct RigidBody : ICollidable
    {
        ...
        internal static class RigidBodyUtil
        {
            ...
            public static bool CastRay<T>(BlobAssetReference<Collider> bodyCollider, EntityId rbEntity, RaycastInput input, ref T collector, RigidTransform worldFromBody, float unifromScale = 1.0f)
            ...
            public static bool CastCollider<T>(BlobAssetReference<Collider> bodyCollider, EntityId rbEntity, ColliderCastInput input, ref T collector, RigidTransform worldFromBody, float uniformScale = 1.0f)
            ...
            public static bool CalculateDistance<T>(BlobAssetReference<Collider> bodyCollider, EntityId rbEntity, PointDistanceInput input, ref T collector, RigidTransform worldFromBody, float uniformScale = 1.0f)
            ...
            public static bool CalculateDistance<T>(BlobAssetReference<Collider> bodyCollider, EntityId rbEntity, ColliderDistanceInput input, ref T collector, RigidTransform worldFromBody, float uniformScale = 1.0f)
                where T : struct, ICollector<DistanceHit>
            {
                // Transform the input into body space
            ...
            internal static void SetQueryContextParameters(ref QueryContext context, in ScaledMTransform worldFromBody, float invTargetUniformScale, EntityId rigidBodyEntity)
            {
