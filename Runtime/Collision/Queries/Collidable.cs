            ...
            where C : struct, ICollector<DistanceHit>
        {
            ...
            unsafe
            {
                fixed(T* ptr = &target)
                {
                    ...
                    {
                        var interactionCollector = new QueryInteractionCollector<DistanceHit, C>(ref collector, true, EntityId.Invalid);
            ...
            where C : struct, ICollector<ColliderCastHit>
        {
            ...
            unsafe
            {
                fixed(T* ptr = &target)
                {
                    ...
                    {
                        var interactionCollector = new QueryInteractionCollector<ColliderCastHit, C>(ref collector, true, EntityId.Invalid);
